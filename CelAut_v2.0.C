...
int main(int argc, char *argv[]){
  ...
  // dskw3=fopen("./Data/DOAS/Cel
  err=sprintf(FileName,"CelAut_v2.0_ave%04d.dat",Cloud_Width);
  err++;
  ...
  for(int t=0;t<=3*Ny;t++){
    ...
    /*    if(t%2==0)
	  phi_0[Nx/2][2][5]=1;  */
    //err=sprintf(FileName,"./Data/DOAS/CelAut_v2.0_t%04d.dat",t);
    //err++;
...
rm *.mp4
avconv -i CelAut_v2.0_%04d.png long_cloud.mp4
